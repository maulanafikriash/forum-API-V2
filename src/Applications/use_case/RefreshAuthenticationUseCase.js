...
class RefreshAuthenticationUseCase {
  ...
  _verifyPayload(payload) {
    ...
    if (!refreshToken) {
      throw new InvariantError('REFRESH_AUTHENTICATION_USE_CASE.NOT_CONTAIN_REFRESH_TOKEN');
    }

    if (typeof refreshToken !== 'string') {
      throw new InvariantError('REFRESH_AUTHENTICATION_USE_CASE.PAYLOAD_NOT_MEET_DATA_TYPE_SPECIFICATION');
    }
  }
}
